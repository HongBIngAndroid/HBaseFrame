...
public class InputFiltor implements InputFilter {
    ...
    private String wait;
    Pattern p;
    public InputFiltor(Context context,String pleft,String wait){
        this.context = context;
        this.pleft = pleft;
        this.wait = wait;
        MAX_VALUE = Double.valueOf(pleft) - Double.valueOf(wait);
...
//            if(dold > MAX_VALUE){
//                Toast.makeText(context, "大于最大金额:"+MAX_VALUE,Toast.LENGTH_SHORT).show();
//                return dest.subSequence(dstart, dend);
//            }else if(dold == MAX_VALUE){
//                if(src.toString().equals(".")){
//                    Toast.makeText(context, "输入的最大金额不能大于可用余额",Toast.LENGTH_SHORT).show();
//                    return dest.subSequence(dstart, dend);
//                }
//            }
//        }
